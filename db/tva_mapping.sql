...
(2, 9, "Employee has a lack of education in Information Security", "An employee could accidentally introduce threats into the company system via Phishing", 5, 3),
(3, 1, "Physical breach", "An attacker could physically break into the company's server room and destroy equipment or intoduce malware into the web server", 3, 5),
(4, 3, "SQL Injection", "An attacker could insert malicious SQL code into the e-commerce platform", 4, 5),
(5, 8, "Insecurely stored passwords and user credentials", "Weak passwords or unsafely stores login information can be easily obtained and used by an attacker to access the company's systems", 5, 4),
...
(10, 12, "Payment processing platform going down", "If the e-commerce platform were to go down, the company would lose money and creditability", 3, 4),
